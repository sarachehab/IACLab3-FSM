...
void Vlfsr___024root__trace_chg_sub_0(Vlfsr___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vlfsr___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlfsr___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vlfsr___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vlfsr___024root__trace_chg_sub_0(Vlfsr___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vlfsr__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlfsr___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgCData(oldp+4,(vlSelf->lfsr__DOT__sreg),8);
}
