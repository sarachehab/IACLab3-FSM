...
void Vf1_auto___024root___eval_act(Vf1_auto___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_auto__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root___eval_act\n"); );
}

VL_INLINE_OPT void Vf1_auto___024root___nba_sequent__TOP__0(Vf1_auto___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_auto__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root___nba_sequent__TOP__0\n"); );
    // Body
    vlSelf->__Vdly__f1_auto__DOT__second_delay__DOT__count 
        = vlSelf->f1_auto__DOT__second_delay__DOT__count;
}

VL_INLINE_OPT void Vf1_auto___024root___nba_sequent__TOP__1(Vf1_auto___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_auto__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root___nba_sequent__TOP__1\n"); );
    // Body
    if (vlSelf->rst) {
        vlSelf->f1_auto__DOT__f1_lights__DOT__current_state = 0U;
    } else if (vlSelf->f1_auto__DOT__light_trigger) {
        vlSelf->f1_auto__DOT__f1_lights__DOT__current_state 
            = vlSelf->f1_auto__DOT__f1_lights__DOT__next_state;
    }
...
VL_INLINE_OPT void Vf1_auto___024root___nba_sequent__TOP__2(Vf1_auto___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_auto__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root___nba_sequent__TOP__2\n"); );
    // Body
    if (vlSelf->rst) {
        vlSelf->f1_auto__DOT__light_trigger = 0U;
        vlSelf->__Vdly__f1_auto__DOT__second_delay__DOT__count 
            = vlSelf->N;
    } else if ((0U == (IData)(vlSelf->f1_auto__DOT__second_delay__DOT__count))) {
        vlSelf->f1_auto__DOT__light_trigger = 1U;
        vlSelf->__Vdly__f1_auto__DOT__second_delay__DOT__count 
            = vlSelf->N;
    } else {
        vlSelf->__Vdly__f1_auto__DOT__second_delay__DOT__count 
            = (0xffffU & ((IData)(vlSelf->f1_auto__DOT__second_delay__DOT__count) 
                          - (IData)(1U)));
        vlSelf->f1_auto__DOT__light_trigger = 0U;
    }
    vlSelf->f1_auto__DOT__second_delay__DOT__count 
...
void Vf1_auto___024root___eval_nba(Vf1_auto___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_auto__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root___eval_nba\n"); );
    // Body
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vf1_auto___024root___nba_sequent__TOP__0(vlSelf);
    }
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vf1_auto___024root___nba_sequent__TOP__1(vlSelf);
        vlSelf->__Vm_traceActivity[1U] = 1U;
    }
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vf1_auto___024root___nba_sequent__TOP__2(vlSelf);
    }
}
...
void Vf1_auto___024root___eval(Vf1_auto___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_auto__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root___eval\n"); );
    // Init
    ...
    while (__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            Vf1_auto___024root___eval_triggers__act(vlSelf);
...
#endif
                    VL_FATAL_MT("f1_auto.sv", 1, "", "Active region did not converge.");
                }
                vlSelf->__VactIterCount = ((IData)(1U) 
                                           + vlSelf->__VactIterCount);
                __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
                vlSelf->__VnbaTriggered.thisOr(vlSelf->__VactTriggered);
                Vf1_auto___024root___eval_act(vlSelf);
            }
        }
...
#ifdef VL_DEBUG
                Vf1_auto___024root___dump_triggers__nba(vlSelf);
#endif
                VL_FATAL_MT("f1_auto.sv", 1, "", "NBA region did not converge.");
            }
            __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
            Vf1_auto___024root___eval_nba(vlSelf);
        }
    }
}
...
void Vf1_auto___024root___eval_debug_assertions(Vf1_auto___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_auto__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root___eval_debug_assertions\n"); );
    // Body
