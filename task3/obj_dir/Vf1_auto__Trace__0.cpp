...
void Vf1_auto___024root__trace_chg_sub_0(Vf1_auto___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vf1_auto___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vf1_auto___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vf1_auto___024root__trace_chg_sub_0(Vf1_auto___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_auto__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root__trace_chg_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    // Body
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgIData(oldp+0,(vlSelf->f1_auto__DOT__f1_lights__DOT__current_state),32);
        bufp->chgIData(oldp+1,((((((((((0U == vlSelf->f1_auto__DOT__f1_lights__DOT__current_state) 
                                                  ...
                                                  ((4U 
                                                   ...
                                                   ((5U 
                                                    ...
                                                    ((6U 
                                                      ...
                                                      : 8U)))))))
                                 : 0U)),32);
        bufp->chgCData(oldp+2,(vlSelf->f1_auto__DOT__f1_lights__DOT__out),8);
    }
    bufp->chgBit(oldp+3,(vlSelf->clk));
    bufp->chgBit(oldp+4,(vlSelf->rst));
    bufp->chgSData(oldp+5,(vlSelf->N),16);
    bufp->chgCData(oldp+6,(vlSelf->data_out),8);
    bufp->chgBit(oldp+7,(vlSelf->f1_auto__DOT__light_trigger));
    bufp->chgSData(oldp+8,(vlSelf->f1_auto__DOT__second_delay__DOT__count),16);
}

void Vf1_auto___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_auto___024root__trace_cleanup\n"); );
    // Init
    Vf1_auto___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vf1_auto___024root*>(voidSelf);
    Vf1_auto__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
